...
- [x] Implement `generate_cds_red` in `src/codonlm/generate.py`.
...
- [x] Implement `batch_red_sampler` to manage budget across multiple prefixes.

## Phase 3: Implementation - Benchmarking Script
- [x] Create `scripts/benchmark_red.py`.
...
- [x] Run benchmark on `2026-06-05_stage2.5_6L4H_d256_e10`.
- [x] Generate comparison plots.
- [x] Document findings in `DEVELOPMENT_LOG.md`.
