...
- [x] **Task 1.1: Partial Sequence Evaluation**
  - Implement dynamic codon-to-amino-acid translation during autoregressive generation for incomplete sequences.
- [x] **Task 1.2: Logit Blending Logic**
  - Implement a configurable weight parameter ($\alpha$) to blend next-token logits from CodonLM and partial-sequence logits from the Multi-Task Critic / EBM.

## Phase 2: Evaluation & Benchmarking
- [x] **Task 2.1: Benchmarking Script**
...
- [x] **Task 3.1: Streamlit Dashboard Tab**
  - Integrate hybrid guidance toggles into the Model Playground tab.
- [x] **Task 3.2: Verification Tests**
