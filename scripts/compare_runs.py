...
from scripts._shared import RUNS_DIR, ensure_run_layout, read_meta
...
def main():
    ...
    ap.add_argument("--out", default="runs/_summary/summary.csv", help="Output CSV path")
    args = ap.parse_args()
    ...
    if not run_ids:
        ...
        run_ids = [d.name for d in RUNS_DIR.iterdir() if d.is_dir() and not d.name.startswith("_")]
