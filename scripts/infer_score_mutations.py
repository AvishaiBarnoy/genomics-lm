...
def main():
    ...
    ap.add_argument(
        "--seq", required=True, help="space-separated codons from ATG ... STOP"
    )
    ...
    plt.xlabel("codon")
    plt.ylabel("position")
    plt.title("ΔlogP heatmap")
    plt.tight_layout()
    plt.savefig(out_dir / "mut_scores_heatmap.png")
    plt.close()
